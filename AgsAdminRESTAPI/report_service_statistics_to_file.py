...
"""
This example retrieves usage statistics (total number of requests, maximum and average response time,
and total timed-out requests) from a particular service on your server for a specified period of time.
