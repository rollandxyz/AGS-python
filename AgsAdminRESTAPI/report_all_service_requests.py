...
"""
This example creates a report showing all service request statistics collected by ArcGIS Server.
The script generates a comma separated values (CSV) file that you can either parse or open as a spreadsheet
(for example, in Microsoft Office or an equivalent application) for further analysis. R
eported requests do not include all activity in your site;
for a detailed list of the requests that are collected, see Working with server statistics.
"""
